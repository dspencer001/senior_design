...
int main(int argc, const char *argv[])
{
    ...
    std::cout << "old CC: " << capture.get(cv::CAP_PROP_FOURCC) << std::endl;
    std::cout << "Wanted CC: " << VideoWriter::fourcc('M', 'J', 'P', 'G') << std::endl;

    capture.set(cv::CAP_PROP_FOURCC, VideoWriter::fourcc('M', 'J', 'P', 'G'));
    std::cout << "CC: " << capture.get(cv::CAP_PROP_FOURCC) << std::endl;
    //capture.set(cv::CAP_PROP_FRAME_WIDTH, 2000); // valueX = your wanted width 
    //capture.set(cv::CAP_PROP_FRAME_HEIGHT, 2000); // valueY = your wanted heigth
